...
docker run --rm --volume="$DATA/LA_$l":/data cemrg/uac:3.0-alpha fibremap --atrium la --layer $l --fibre $f --msh LA_only --msh-endo Labelled --msh-epi Labelled --output "Fibre"$f"_"
...
docker run --rm --volume="$DATA/LA_epi":/data cemrg/uac:3.0-alpha fibremap --atrium la --layer bilayer --fourch --fibre $f --msh LA_only --msh-endo Labelled --msh-epi Labelled --output "Fibre"$f"_"
